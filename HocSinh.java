...
class main {
    public static void main(String[] args) {
       ...
       System.out.println("Diem Trung Binh:"+hS.diemTrungbinh("Nguyen van a", 5, 3, 7));
       HocSinhchuyentoan hScT = new HocSinhchuyentoan();
       System.out.println("Diem Trung Binh hs Chuyen Toan: "+ hScT.diemTrungbinh("Nguyen Van B", 8, 7, 7));
    }
}
